...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> _ar = {
    ...
    "onboarding": {
      ...
      "desc3":
          "حلول تنظيف عالية الجودة مصممة للحفاظ على سيارتك في أفضل حالاتها.",
    },
    "language": {"english": "الانجليزية", "arabic": "العربية"},
    "auth": {
      "login": "تسجيل الدخول",
  ...
  static const Map<String, dynamic> _en = {
    ...
    "onboarding": {
      ...
      "desc1":
          "Professional car wash services delivered to your location with just a few taps.",
      "desc2":
          "Book, track, and enjoy seamless car care from the comfort of your home or office.",
      "desc3":
          "Premium cleaning solutions tailored to keep your car looking its best.",
    },
