...
class SubscriptionWash {
  ...
  final List<SubscriptionPackageAddon> availableOptionalAddons;
  ...
  factory SubscriptionWash.fromJson(Map<String, dynamic> json) {
    return SubscriptionWash(
      ...
      availableOptionalAddons: (json['availableOptionalAddons'] as List<dynamic>?)
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'canCancel': canCancel,
      'addOns': addOns,
      'availableOptionalAddons': availableOptionalAddons.map((e) => e.toJson()).toList(),
    };
  }
}
